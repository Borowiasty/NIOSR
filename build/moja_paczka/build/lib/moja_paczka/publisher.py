...
class NewPublisher(Node):
    ...
    def __init__(self):
        ...
        cv2.setMouseCallback(self.window_name, self.get_mouse_click) # sprawdzamy czy kliknlismy
    ...
    def timer_callback(self):
        ...
        if self.x_y != None:
            ...
            if self.x_y[1] > self.window_size[1] // 2 : #czy klikniete w drugiej polowie ekranu
